...
class scheduler:
   ...
   def new_process(self):
        ...
        #For each process add a new dictionary with the 
        #program counter, the id, the code and its state
   ...
   def load_file(self, progfile):
        fd = open(progfile)
        #simulates the creation of a new process with the code of a program loading
